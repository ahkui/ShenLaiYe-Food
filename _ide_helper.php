 ...
 * Generated for Laravel 5.5.31 on 2018-01-17.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Queue {
        ...
        {
            return \Jenssegers\Mongodb\Queue\MongoQueue::pop($queue);
        }
        ...
        public static function size($queue = null)
        {
            ...
            return \Jenssegers\Mongodb\Queue\MongoQueue::size($queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\DatabaseQueue            
            return \Jenssegers\Mongodb\Queue\MongoQueue::push($job, $data, $queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\DatabaseQueue            
            return \Jenssegers\Mongodb\Queue\MongoQueue::pushRaw($payload, $queue, $options);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\DatabaseQueue            
            \Jenssegers\Mongodb\Queue\MongoQueue::later($delay, $job, $data, $queue);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\DatabaseQueue            
            return \Jenssegers\Mongodb\Queue\MongoQueue::bulk($jobs, $data, $queue);
        }
        ...
        public static function pushOn($queue, $job, $data = '')
        {
            ...
            return \Jenssegers\Mongodb\Queue\MongoQueue::pushOn($queue, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Jenssegers\Mongodb\Queue\MongoQueue::laterOn($queue, $delay, $job, $data);
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Jenssegers\Mongodb\Queue\MongoQueue::getConnectionName();
        }
        ...
        {
            //Method inherited from \Illuminate\Queue\Queue            
            return \Jenssegers\Mongodb\Queue\MongoQueue::setConnectionName($name);
        }
...
namespace SKAgarwal\GoogleApi { 
    ...
    class Facade {
         ...
         * @static 
         */ 
        public static function nearbySearch($location, $radius = null, $params = array())
        {
            return \SKAgarwal\GoogleApi\PlacesApi::nearbySearch($location, $radius, $params);
        }
         ...
         * @static 
         */ 
        public static function textSearch($query, $params = array())
        {
            return \SKAgarwal\GoogleApi\PlacesApi::textSearch($query, $params);
        }
         ...
         * @static 
         */ 
        public static function radarSearch($location, $radius, $params)
        {
            return \SKAgarwal\GoogleApi\PlacesApi::radarSearch($location, $radius, $params);
        }
         ...
         * @static 
         */ 
        public static function placeDetails($placeId, $params = array())
        {
            return \SKAgarwal\GoogleApi\PlacesApi::placeDetails($placeId, $params);
        }
         ...
         * @static 
         */ 
        public static function placeAutocomplete($input, $params = array())
        {
            return \SKAgarwal\GoogleApi\PlacesApi::placeAutocomplete($input, $params);
        }
         ...
         * @static 
         */ 
        public static function queryAutocomplete($input, $params = array())
        {
            return \SKAgarwal\GoogleApi\PlacesApi::queryAutocomplete($input, $params);
        }
        ...
        {
            return \SKAgarwal\GoogleApi\PlacesApi::addPlace($params);
        }
        ...
        {
            return \SKAgarwal\GoogleApi\PlacesApi::deletePlace($placeId);
        }
        ...
        {
            return \SKAgarwal\GoogleApi\PlacesApi::getStatus();
        }
        ...
        public static function getKey()
        {
            return \SKAgarwal\GoogleApi\PlacesApi::getKey();
        }
        ...
        {
            return \SKAgarwal\GoogleApi\PlacesApi::setKey($key);
        }
        ...
        {
            return \SKAgarwal\GoogleApi\PlacesApi::verifySSL($verifySSL);
        }
